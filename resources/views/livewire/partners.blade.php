<div>
    <div x-data="{ embla: null, next: true, prev: true }" x-init="() => {
        ...
        <div x-ref="viewport" class="embla__viewport px-10">
            <div class="embla__container px-10">
                <partner-slider :partners="{{ $partner_list }}"></partner-slider>
                {{-- @foreach ($partner_list as $partner)
                <div class="embla__slide_partners {{ $loop->first ? 'pl-30' : '' }}">
    ...
    <button id="partner_scroll" :disabled="!next" @click="embla.scrollNext()" class="embla__button embla__button--next"
        type="button">
