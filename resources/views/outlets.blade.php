...
<script>
    ...
    "geometry": {
    "type": "Point",
    "coordinates": [ 73.506190,4.173925]
    }
    }]
    }
    },
    ...
    container: 'map_two',
    style: 'mapbox://styles/mapbox/streets-v11',
    center: [73.507739,4.179599],
    zoom: 15
    });
    var size = 200;
    map_two.scrollZoom.disable();
    // implementation of CustomLayerInterface to draw a pulsing dot icon on the map
    // see https://docs.mapbox.com/mapbox-gl-js/api/#customlayerinterface for more info
    var pulsingDot = {
    width: size,
    ...
    map_two.addImage('pulsing-dot', pulsingDot, {
    pixelRatio: 2
    });
    ...
    "geometry": {
    "type": "Point",
    "coordinates": [73.507739,4.179599]
    }
    }]
    }
    },
